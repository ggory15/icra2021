...
w_com = 500.0             # weight of center of mass task
w_foot = 10.0          # weight of the foot motion task
w_contact = 70.0        # weight of foot in contact (negative means infinite weight)
...
# gain_vector[:12] = gain_vector[:12] * 0.1
